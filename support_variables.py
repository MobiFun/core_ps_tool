...
add_m3lnk = 'ADD M3LNK: SRN={SRN}, SN={SN}, LNK={LNK}, IPT=IPV4, LOCIPV41="{LOCIPV41}", ' \
            'LOCIPV42="{LOCIPV42}", LOCPORT={LOCPORT}, PEERIPV41="{PEERIPV41}", ' \
            'PEERIPV42="{PEERIPV42}", PEERPORT={PEERPORT}, CS=S, LSX={LSX}, CROSSIP=NO, SCTPINDX=1, LKN="{RNC_Name}";'
...
add_rnc = 'ADD RNC: RNCX={RNCX}, RNCN="{RNC_Name}", RNCMCC="{RNCMCC}", RNCMNC="{RNCMNC}", RNCID={RNCINDEX}, ' \
          'NI={NI}, SPC="{DPC}", IMS=NO, IU-FLEX={Iu_Flex}, RANSHR={RanSharing}, UESBI=YES, RNCVER=R8, OTS={DT}, ' \
...
add_rnc_r7 = 'ADD RNC: RNCX={RNCX}, RNCN="{RNC_Name}", RNCMCC="{RNCMCC}", RNCMNC="{RNCMNC}",' \
             ' RNCID={RNCINDEX}, NI={NI}, SPC="{DPC}", IMS=NO, IU-FLEX={Iu_Flex}, RANSHR={RanSharing}, RNCVER=R7, ' \
             'OTS=YES, R7QOS={R7_QOS}, RABQOS={RAB_QOS}, ALTBRTYPE=VALUERANGE, CHGSYMTOASYMBI=NO, SGSNBUF=NO;'
